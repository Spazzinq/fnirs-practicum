...
try
    ...
    num_subj = size(between_subj_level.patterns,3);
    num_feat = size(between_subj_level.patterns,2); 
catch
    % Old version of toolbox had different field names
    num_subj = size(between_subj_level.summed_mcpa_patterns,3);
    num_feat = size(between_subj_level.summed_mcpa_patterns,2);
end
