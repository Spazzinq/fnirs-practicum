...
% Check for results_struct
arg_names = varargin(1:2:end);
val_names = varargin(2:2:end);
if ~any(strcmp(arg_names, 'results_struct'))
    allsubj_results = setup_MCPA_data(MCP_struct,varargin);    
else
    allsubj_results = val_names{strcmp(arg_names, 'results_struct')};
end
...
for s_idx = 1:n_subj    
    ...
    [train_data, train_labels, test_data, test_labels] = split_test_and_train(s_idx,...
        ...
        allsubj_results.event_types,...             % Do NOT subsitute allsubj_results.conditions here!! 
