function [classification, comparisons] = mcpa_classify_2(model_data, model_labels, test_data, test_labels, opts)
...
test_patterns = nan(size(test_dat,2),length(model_classes));
